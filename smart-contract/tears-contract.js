...
contract DevopsTearsToken is ForeignTokenProvider {
    ...
    function name() public pure returns (string) {return "DevOps Tears token";}

    function symbol() public pure returns (string) {return "TEAR";}
